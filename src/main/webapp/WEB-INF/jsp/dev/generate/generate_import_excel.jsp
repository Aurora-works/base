...
<body>
<form id="sys_generate_import_form" method="post" enctype="multipart/form-data">
    ...
    <div style="width:100%; float: left; padding: 10px 20px">
        <a id="sys_generate_import_btn" href="javascript:" class="easyui-linkbutton" style="width:100%">上传</a>
    </div>
</form>
<script type="text/javascript">
    $('#sys_generate_import_form').click(function () {
        $('#sys_generate_import_form').form('submit', {
            url: 'sys/generate/excel/in',
            onSubmit: function () {
